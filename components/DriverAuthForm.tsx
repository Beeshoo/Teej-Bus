  ...
  return (
    <div className="max-w-md mx-auto my-12 bg-slate-900 rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-800 animate-fadeIn text-white">
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-4 bg-slate-900">
        ...
        {!isLogin && (
          <>
            <div className="space-y-1">
              <label className="text-base font-bold text-slate-500 mr-2">الاسم الكامل للكابتن</label>
              <input 
                type="text" 
                required 
            ...
            <div className="space-y-1">
              <label className="text-base font-bold text-slate-500 mr-2">رقم رخصة القيادة</label>
              <input 
                type="text" 
                required 
                className="w-full p-4 bg-slate-800 rounded-2xl border border-slate-700 focus:ring-2 focus:ring-emerald-500 outline-none text-white" 
            ...
            <div className="space-y-1">
              <label className="text-base font-bold text-slate-500 mr-2">رابط الصورة الشخصية (URL)</label>
              <input 
                type="url" 
        ...
        <div className="space-y-1">
          <label className="text-base font-bold text-slate-500 mr-2">البريد الإلكتروني</label>
          <input 
            type="email" 
            required 
            className="w-full p-4 bg-slate-800 rounded-2xl border border-slate-700 focus:ring-2 focus:ring-emerald-500 outline-none text-white" 
