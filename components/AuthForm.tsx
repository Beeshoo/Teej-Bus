  ...
  return (
    <div className="max-w-md mx-auto my-4 md:my-12 bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 animate-fadeIn">
      ...
      <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-3 md:space-y-4">
        ...
        {!isLogin && (
          <>
            <div className="space-y-1">
              <label className="text-xs md:text-sm font-bold text-gray-400 mr-2">الاسم بالكامل</label>
              <input 
                type="text" 
                required 
            ...
            <div className="space-y-1">
              <label className="text-xs md:text-sm font-bold text-gray-400 mr-2">رقم الهاتف</label>
              <input 
                type="tel" 
                required 
            ...
            <div className="space-y-1">
              <label className="text-xs md:text-sm font-bold text-gray-400 mr-2">تاريخ الميلاد</label>
        ...
        <div className="space-y-1">
          <label className="text-xs md:text-sm font-bold text-gray-400 mr-2">البريد الإلكتروني</label>
          <input 
            type="email" 
            required 
            className="w-full p-3 md:p-4 bg-gray-50 rounded-xl md:rounded-2xl border border-gray-100 focus:ring-2 focus:ring-amber-500 outline-none text-sm md:text-base" 
        ...
        <div className="space-y-1">
          <label className="text-xs md:text-sm font-bold text-gray-400 mr-2">كلمة المرور</label>
          <input 
            type="password" 
            required 
            className="w-full p-3 md:p-4 bg-gray-50 rounded-xl md:rounded-2xl border border-gray-100 focus:ring-2 focus:ring-amber-500 outline-none text-sm md:text-base" 
